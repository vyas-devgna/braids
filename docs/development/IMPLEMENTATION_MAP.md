...
| 3 Evaluation harness | corpus done, unrun | 92 cases, 60 balanced trigger prompts, 8 fixture families; no `--results` file exists |
...
| 6 Token/context | static budget done, per-run open | `scripts/measure_budget.py`; Claude Code measured 192 always-on / ~2.8k on-invoke |
